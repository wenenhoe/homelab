...
compromised `storage` host — the same host [0010](../0010-preventing-homelab-side-deletion-of-offsite-copies/revision-000.md)
and [0006](../0006-offsite-backup-credential-blast-radius/revision-000.md) already
...
against [0017](../0017-recovering-the-secrets-store-from-total-loss/revision-000.md)'s own reasoning
...
same per-host credential containment [0006](../0006-offsite-backup-credential-blast-radius/revision-000.md)
