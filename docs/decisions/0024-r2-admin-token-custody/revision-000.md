...
[0023](../0023-reusing-cloud-credential-logic-with-the-secrets-store/revision-000.md) puts every other
...
moving the token doesn't change what [0014](../0014-r2-rotation-credential-cannot-be-narrowed/revision-000.md)
...
`controller`'s single broad policy ([0020](../0020-automation-identity-and-access-scope/revision-000.md)),
...
master-rotation cadence [0023](../0023-reusing-cloud-credential-logic-with-the-secrets-store/revision-000.md)
...
- Blast radius is unchanged from [0014](../0014-r2-rotation-credential-cannot-be-narrowed/revision-000.md)'s
...
- The per-read alert is new work: no existing consumer in
  ...
  [0026](../0026-detecting-reads-of-high-value-secrets/revision-000.md) for how
