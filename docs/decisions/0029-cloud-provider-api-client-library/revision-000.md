...
weak point
([0014](../0014-r2-rotation-credential-cannot-be-narrowed/revision-000.md)'s
...
- This decision is independent of
  [`../0030-openbao-client-implementation-in-repo-python/revision-000.md`](../0030-openbao-client-implementation-in-repo-python/revision-000.md)'s
