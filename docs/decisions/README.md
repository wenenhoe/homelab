...
implements, linked by the project's `decision:` field. Several projects
may implement one revision; it becomes `accepted` in the pull request that
closes the last of them, and the resulting behavior is described in topic
docs. See
[`docs/projects/README.md#when-a-project-finishes`](../projects/README.md#when-a-project-finishes).
...
| [0060](0060-tracking-and-managing-code-review-findings-for-a-public-repository/revision-000.md) | **Tracking and managing code-review findings for a public repository** — Where automated code-review findings live, given the repo they describe is public. | A private tracker repo (homelab-security) holding one structured file per finding, not a mirror of the public repo's code | Accepted | Related: [0061](0061-where-automated-code-review-runs-and-what-it-may-write/revision-000.md) |
