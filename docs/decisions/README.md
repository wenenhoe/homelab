...
| [0037](0037-decision-and-project-documentation-workflow/revision-001.md) | **Recording decisions, tracking execution, and keeping docs true** — How why, what-remains, and what-is-true-now are kept apart, extended to close a visibility gap the original method left open. | also_implements: as a validated, non-gating frontmatter field, plus a generated view of open ADRs no project covers | Accepted (revision 1) | Related: [0050](0050-agent-authored-changes-reaching-production/revision-000.md), [0055](0055-maintainer-client-access-to-the-coding-agent-host/revision-000.md) |
