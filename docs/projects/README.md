...
| [`coderabbit-image-pinning.md`](coderabbit-image-pinning.md) | De-risking | Pin the CodeRabbit CLI in the review image, bump it with Renovate, move the base to Ubuntu LTS, and tag images by CLI version. |
