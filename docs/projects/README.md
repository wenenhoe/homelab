...
| [`coderabbit-pr-scope-trim.md`](coderabbit-pr-scope-trim.md) | Not started | Rescope tools/coderabbit-review/ to per-PR diff review only; move image building into CI. |
