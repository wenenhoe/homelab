...
| [`tools-secrets-package-split.md`](tools-secrets-package-split.md) | Not started | Move ansible/cloud_credentials/ to tools/cloud_credentials/ and extract the scattered OpenBao/Vault client (cache.py, bootstrap_secrets.py, r2_read_watcher.py) into a shared tools/secrets/ package. |
