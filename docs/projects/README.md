...
| [`tools-secrets-package-split.md`](tools-secrets-package-split.md) | In progress | Move ansible/cloud_credentials/ to tools/cloud_credentials/ and extract cache.py's generic OpenBao/Vault client pieces (also duplicated in bootstrap_secrets.py) into a shared tools/secrets/ package. |
