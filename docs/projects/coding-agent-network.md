...
| 4 | Canary probes from outside the future host | Not started | Probes to the secrets store, CD agent, managed hosts, workstation, and Proxmox management address all fail |
