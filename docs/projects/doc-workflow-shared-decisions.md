...
| 4 | Name the close check in the root `README.md`'s hook list and in `docs/README.md` | Done | Both name `check-project-close` beside `check-project-scope`; `check-project-scope.py` passes with the widened scope on the base |
