# molecule-coverage: development log

For what this tool does and how to use it, see `README.md` in this same
directory. This file is the build history instead - what was tried, what
broke, and how each bug got found and fixed, stage by stage, roughly in
the order it happened. Useful if you're modifying this tool or want the
full reasoning behind a design choice; not necessary just to use it.
...
Being built incrementally. Currently implemented:
